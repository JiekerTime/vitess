...
func TestInformationSchemaQuery(t *testing.T) {
	...
	assertSingleRowIsReturned(t, conn, "table_schema = 'ks'", topoproto.VtDbPrefix+"ks")
	...
	assertSingleRowIsReturned(t, conn, "table_schema = 'ks' and table_name = 't1'", topoproto.VtDbPrefix+"ks")
}
