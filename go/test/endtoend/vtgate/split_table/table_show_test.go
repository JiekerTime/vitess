...
func TestShowTable(t *testing.T) {
	...
	got := "[[VARCHAR(\"t_1\")] [VARCHAR(\"t_1_0\")] [VARCHAR(\"t_1_1\")] [VARCHAR(\"t_2\")] [VARCHAR(\"t_2_0\")] [VARCHAR(\"t_2_1\")] [VARCHAR(\"t_3\")] [VARCHAR(\"t_3_0\")] [VARCHAR(\"t_3_1\")] " +
		...
		"[VARCHAR(\"t_7\")] [VARCHAR(\"t_7_0\")] [VARCHAR(\"t_7_1\")] [VARCHAR(\"t_8\")] [VARCHAR(\"t_8_0\")] [VARCHAR(\"t_8_1\")] [VARCHAR(\"t_music\")] [VARCHAR(\"t_music_0\")] [VARCHAR(\"t_music_1\")] [VARCHAR(\"t_seq\")] " +
	...
	got1 := "[[VARBINARY(\"t_1\")] [VARBINARY(\"t_1_0\")] [VARBINARY(\"t_1_1\")] [VARBINARY(\"t_2\")] [VARBINARY(\"t_2_0\")] [VARBINARY(\"t_2_1\")] [VARBINARY(\"t_3\")] [VARBINARY(\"t_3_0\")] [VARBINARY(\"t_3_1\")] " +
		...
		"[VARBINARY(\"t_7\")] [VARBINARY(\"t_7_0\")] [VARBINARY(\"t_7_1\")] [VARBINARY(\"t_8\")] [VARBINARY(\"t_8_0\")] [VARBINARY(\"t_8_1\")] [VARBINARY(\"t_music\")] [VARBINARY(\"t_music_0\")] [VARBINARY(\"t_music_1\")] [VARBINARY(\"t_seq\")] " +
	...
	got = "[[VARCHAR(\"t_1\")] [VARCHAR(\"t_1_0\")] [VARCHAR(\"t_1_1\")] [VARCHAR(\"t_2_1\")] [VARCHAR(\"t_3_1\")] [VARCHAR(\"t_4_1\")] [VARCHAR(\"t_5_1\")] [VARCHAR(\"t_6_1\")] [VARCHAR(\"t_7_1\")] [VARCHAR(\"t_8_1\")] [VARCHAR(\"t_music_1\")] [VARCHAR(\"t_user_1\")] [VARCHAR(\"t_user_extra_1\")]]"
	got1 = "[[VARBINARY(\"t_1\")] [VARBINARY(\"t_1_0\")] [VARBINARY(\"t_1_1\")] [VARBINARY(\"t_2_1\")] [VARBINARY(\"t_3_1\")] [VARBINARY(\"t_4_1\")] [VARBINARY(\"t_5_1\")] [VARBINARY(\"t_6_1\")] [VARBINARY(\"t_7_1\")] [VARBINARY(\"t_8_1\")] [VARBINARY(\"t_music_1\")] [VARBINARY(\"t_user_1\")] [VARBINARY(\"t_user_extra_1\")]]"
