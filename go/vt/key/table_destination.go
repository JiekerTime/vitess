...
type TableDestination interface {
	...
	Resolve(*tableindexes.LogicTableConfig, func(actualTableIndex int) error) error
...
func (d DestinationTable) Resolve(tables *tableindexes.LogicTableConfig, addTable func(actualTableIndex int) error) error {
...
// Resolve is part of the Destination interface.
func (d DestinationAllTables) Resolve(tables *tableindexes.LogicTableConfig, addTable func(actualTableIndex int) error) error {
...
// Resolve is part of the Destination interface.
func (d DestinationAnyTable) Resolve(tables *tableindexes.LogicTableConfig, addTable func(actualTableIndex int) error) error {
...
// Resolve is part of the Destination interface.
func (d DestinationTables) Resolve(tables *tableindexes.LogicTableConfig, addTable func(actualTableIndex int) error) error {
	for _, table := range d {
...
// Resolve is part of the Destination interface.
func (d TableDestinationKeyspaceID) Resolve(tables *tableindexes.LogicTableConfig, addTable func(actualTableIndex int) error) error {
...
func GetTableIndexForKeyspaceID(tables *tableindexes.LogicTableConfig, keyspaceID []byte) (int, error) {
...
// Resolve is part of the Destination interface.
func (d TableDestinationNone) Resolve(allShards *tableindexes.LogicTableConfig, addTable func(table int) error) error {
	return nil
}
