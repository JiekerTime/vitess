...
type DestinationTable uint64

// Resolve is part of the Destination interface.
func (d DestinationTable) Resolve(tables *tableindexes.LogicTableConfig, addTable func(actualTableIndex uint64) error) error {
	return addTable(uint64(d))
}
