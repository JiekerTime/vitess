...
func (m *LoadDataStreamRequest) CloneVT() *LoadDataStreamRequest {
	if m == nil {
		return (*LoadDataStreamRequest)(nil)
	}
	r := &LoadDataStreamRequest{
		EffectiveCallerId: m.EffectiveCallerId.CloneVT(),
		ImmediateCallerId: m.ImmediateCallerId.CloneVT(),
		Target:            m.Target.CloneVT(),
		Query:             m.Query.CloneVT(),
...
func (m *LoadDataStreamRequest) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *LoadDataStreamResponse) CloneVT() *LoadDataStreamResponse {
	if m == nil {
		return (*LoadDataStreamResponse)(nil)
	}
	r := &LoadDataStreamResponse{
		Result: m.Result.CloneVT(),
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *LoadDataStreamResponse) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *BeginExecuteBatchRequest) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *BeginExecuteBatchResponse) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *LoadDataStreamRequest) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *LoadDataStreamRequest) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *LoadDataStreamRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.Lines) > 0 {
		for iNdEx := len(m.Lines) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarint(dAtA, i, uint64(len(m.Lines[iNdEx])))
			i--
			dAtA[i] = 0x3a
		}
	}
...
func (m *LoadDataStreamResponse) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *LoadDataStreamResponse) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *LoadDataStreamResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *LoadDataStreamRequest) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LoadDataStreamResponse) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LoadDataStreamRequest) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LoadDataStreamRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LoadDataStreamRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *LoadDataStreamResponse) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LoadDataStreamResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LoadDataStreamResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ExecuteBatchRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Query = append(m.Query, &BoundQuery{})
...
func (m *ExecuteBatchResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Result = append(m.Result, &QueryResult{})
