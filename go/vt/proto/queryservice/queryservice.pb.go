...
var file_queryservice_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0xff, 0x11, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x3a, 0x0a, 0x07, 0x45,
	...
	0x12, 0x51, 0x0a, 0x0e, 0x4c, 0x6f, 0x61, 0x64, 0x44, 0x61, 0x74, 0x61, 0x53, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x12, 0x1c, 0x2e, 0x71, 0x75, 0x65, 0x72, 0x79, 0x2e, 0x4c, 0x6f, 0x61, 0x64, 0x44,
	0x61, 0x74, 0x61, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x1d, 0x2e, 0x71, 0x75, 0x65, 0x72, 0x79, 0x2e, 0x4c, 0x6f, 0x61, 0x64, 0x44, 0x61, 0x74,
	0x61, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x00, 0x28, 0x01, 0x42, 0x2b, 0x5a, 0x29, 0x76, 0x69, 0x74, 0x65, 0x73, 0x73, 0x2e, 0x69, 0x6f,
...
var file_queryservice_proto_goTypes = []interface{}{
	...
	(*query.LoadDataStreamRequest)(nil),             // 28: query.LoadDataStreamRequest
	...
	(*query.BeginStreamExecuteResponse)(nil),        // 43: query.BeginStreamExecuteResponse
	(*query.MessageStreamResponse)(nil),             // 44: query.MessageStreamResponse
	(*query.MessageAckResponse)(nil),                // 45: query.MessageAckResponse
	(*query.ReserveExecuteResponse)(nil),            // 46: query.ReserveExecuteResponse
	(*query.ReserveBeginExecuteResponse)(nil),       // 47: query.ReserveBeginExecuteResponse
	(*query.ReserveStreamExecuteResponse)(nil),      // 48: query.ReserveStreamExecuteResponse
	(*query.ReserveBeginStreamExecuteResponse)(nil), // 49: query.ReserveBeginStreamExecuteResponse
	(*query.ReleaseResponse)(nil),                   // 50: query.ReleaseResponse
	(*query.StreamHealthResponse)(nil),              // 51: query.StreamHealthResponse
	(*binlogdata.VStreamResponse)(nil),              // 52: binlogdata.VStreamResponse
	(*binlogdata.VStreamRowsResponse)(nil),          // 53: binlogdata.VStreamRowsResponse
	(*binlogdata.VStreamTablesResponse)(nil),        // 54: binlogdata.VStreamTablesResponse
	(*binlogdata.VStreamResultsResponse)(nil),       // 55: binlogdata.VStreamResultsResponse
	(*query.GetSchemaResponse)(nil),                 // 56: query.GetSchemaResponse
	(*query.LoadDataStreamResponse)(nil),            // 57: query.LoadDataStreamResponse
}
var file_queryservice_proto_depIdxs = []int32{
	...
	28, // 28: queryservice.Query.LoadDataStream:input_type -> query.LoadDataStreamRequest
	...
	43, // 43: queryservice.Query.BeginStreamExecute:output_type -> query.BeginStreamExecuteResponse
	44, // 44: queryservice.Query.MessageStream:output_type -> query.MessageStreamResponse
	45, // 45: queryservice.Query.MessageAck:output_type -> query.MessageAckResponse
	46, // 46: queryservice.Query.ReserveExecute:output_type -> query.ReserveExecuteResponse
	47, // 47: queryservice.Query.ReserveBeginExecute:output_type -> query.ReserveBeginExecuteResponse
	48, // 48: queryservice.Query.ReserveStreamExecute:output_type -> query.ReserveStreamExecuteResponse
	49, // 49: queryservice.Query.ReserveBeginStreamExecute:output_type -> query.ReserveBeginStreamExecuteResponse
	50, // 50: queryservice.Query.Release:output_type -> query.ReleaseResponse
	51, // 51: queryservice.Query.StreamHealth:output_type -> query.StreamHealthResponse
	52, // 52: queryservice.Query.VStream:output_type -> binlogdata.VStreamResponse
	53, // 53: queryservice.Query.VStreamRows:output_type -> binlogdata.VStreamRowsResponse
	54, // 54: queryservice.Query.VStreamTables:output_type -> binlogdata.VStreamTablesResponse
	55, // 55: queryservice.Query.VStreamResults:output_type -> binlogdata.VStreamResultsResponse
	56, // 56: queryservice.Query.GetSchema:output_type -> query.GetSchemaResponse
	57, // 57: queryservice.Query.LoadDataStream:output_type -> query.LoadDataStreamResponse
