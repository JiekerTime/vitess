...
func (c *queryClient) LoadDataStream(ctx context.Context, opts ...grpc.CallOption) (Query_LoadDataStreamClient, error) {
	...
	x := &queryLoadDataStreamClient{stream}
	return x, nil
}

type Query_LoadDataStreamClient interface {
	Send(*query.LoadDataStreamRequest) error
	CloseAndRecv() (*query.LoadDataStreamResponse, error)
	grpc.ClientStream
}

type queryLoadDataStreamClient struct {
	grpc.ClientStream
}

func (x *queryLoadDataStreamClient) Send(m *query.LoadDataStreamRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *queryLoadDataStreamClient) CloseAndRecv() (*query.LoadDataStreamResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(query.LoadDataStreamResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func _Query_LoadDataStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(QueryServer).LoadDataStream(&queryLoadDataStreamServer{stream})
}

type Query_LoadDataStreamServer interface {
	SendAndClose(*query.LoadDataStreamResponse) error
	Recv() (*query.LoadDataStreamRequest, error)
	grpc.ServerStream
}

type queryLoadDataStreamServer struct {
	grpc.ServerStream
}

func (x *queryLoadDataStreamServer) SendAndClose(m *query.LoadDataStreamResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *queryLoadDataStreamServer) Recv() (*query.LoadDataStreamRequest, error) {
	m := new(query.LoadDataStreamRequest)
...
var Query_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "LoadDataStream",
			Handler:       _Query_LoadDataStream_Handler,
			ClientStreams: true,
		},
	},
