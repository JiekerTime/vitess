...
func (e *Executor) Execute(ctx context.Context, mysqlCtx vtgateservice.MySQLConnection, c *mysql.Conn, method string, safeSession *SafeSession, sql string, bindVars map[string]*querypb.BindVariable) (result *sqltypes.Result, err error) {
	...
	stmtType, result, err = e.execute(ctx, mysqlCtx, safeSession, sql, bindVars, logStats, c)
	logStats.Error = err
	if result == nil {
...
func (e *Executor) execute(ctx context.Context, mysqlCtx vtgateservice.MySQLConnection, safeSession *SafeSession, sql string, bindVars map[string]*querypb.BindVariable, logStats *logstats.LogStats, c *mysql.Conn) (sqlparser.StatementType, *sqltypes.Result, error) {
	var err error
